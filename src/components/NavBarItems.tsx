...
const NavBarItem: React.FC<NavBarItemProps> = ({ label, link, ind, active }) => {
    return <li 
        className={`uppercase text-base md:text-sm py-2 md:mx-6 md:py-8 text-white tracking-wides border-b-2 ${active ? 'border-b-white' : 'border-b-transparent md:border-b-[#263232] lg:border-b-transparent'} hover:border-b-[#979797] hover:cursor-pointer ${barlow_condensed.className}`}>
